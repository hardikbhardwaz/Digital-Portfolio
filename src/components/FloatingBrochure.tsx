        ...
        <div className="fixed bottom-6 left-6 z-50">
            <MagneticWrapper strength={15}>
                ...
                >
                    ...
                    <FileDown className="w-5 h-5 relative z-10 group-hover:animate-bounce" />
                    <span className="font-heading font-bold text-sm tracking-wide relative z-10 whitespace-nowrap">
                        Download Brochure
                    </span>
