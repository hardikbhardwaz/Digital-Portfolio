...
const DRIVE_FILES = [
    ...
    { id: 'dm1', name: 'Ecom_BFCM_Scaling_Strategy.pdf', type: 'Digital Marketing', cat: 'Digital Marketing', size: '18 MB', thumb: 'https://images.unsplash.com/photo-1432888118086-a36cbb607626?auto=format&fit=crop&q=80', description: 'Comprehensive Meta & Google Ads scaling framework deployed during Black Friday/Cyber Monday, resulting in a 4.2x ROAS and $850k ARR over 4 days.', link: '/projects/ecom-bfcm' },
    { id: 'dm2', name: 'B2B_LeadGen_Framework.xlsx', type: 'Digital Marketing', cat: 'Digital Marketing', size: '4.2 MB', thumb: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80', description: 'Full algorithmic media buying strategy for a high-ticket B2B SaaS, driving down Cost Per SQL by 65% through intense audience segmentation.', link: '/projects/b2b-leadgen' },

    // Funnels Live Projects
    { id: 'fn1', name: 'HighTicket_VSL_Flow.fig', type: 'Funnels', cat: 'Funnels', size: '64 MB', thumb: 'https://images.unsplash.com/photo-1512758684632-eb8c02a2083b?auto=format&fit=crop&q=80', description: 'Architected a multi-step Video Sales Letter funnel with conditional logic, boosting calendar bookings by 240% for an education consulting firm.', link: '/projects/vsl-funnel' },
    { id: 'fn2', name: 'Automated_Webinar_Blueprint.pdf', type: 'Funnels', cat: 'Funnels', size: '12 MB', thumb: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80', description: 'Evergreen GoHighLevel webinar funnel blueprint including indoctrination email sequences, SMS reminders, and seamless Stripe checkout integration.', link: '/projects/webinar-funnel' },

    // Automation Live Projects
    { id: 'au1', name: 'WhatsApp_Cloud_API_Bot.js', type: 'Automation', cat: 'Automation', size: '8 KB', thumb: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80', description: 'Custom Node.js script connecting Facebook Lead Ads directly into a WhatsApp Cloud API conversational bot for instant 1-second lead qualification.', link: '/projects/whatsapp-bot' },
    { id: 'au2', name: 'Make_CRM_Sync_Pipeline.json', type: 'Automation', cat: 'Automation', size: '15 KB', thumb: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80', description: 'A massive Make.com (Integromat) scenario seamlessly syncing Shopify purchases, Stripe webhooks, and HubSpot CRM to trigger automated fulfillment protocols.', link: '/projects/crm-sync' },
                            ...
                            <div className="w-full max-w-4xl bg-[#111] border border-white/10 rounded-2xl overflow-hidden relative shadow-2xl flex flex-col md:flex-row m-auto">
                                ...
                                <div className="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-center bg-black/50 backdrop-blur-3xl relative">
                                    ...
                                    <div className="flex flex-col gap-4 mt-auto relative z-10">
                                        ...
                                        {selectedFile.link ? (
                                            <a href={selectedFile.link} target={selectedFile.link.startsWith('http') ? '_blank' : '_self'} rel="noopener noreferrer" className="group relative w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-gradient-to-r from-luxury-blue to-luxury-violet text-white overflow-hidden transition-all duration-500 hover:scale-[1.02] shadow-[0_4px_20px_rgba(0,85,255,0.4)] hover:shadow-[0_0_50px_rgba(143,0,255,0.6)]">
