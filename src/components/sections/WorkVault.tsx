...
const DRIVE_FILES = [
    ...
    { id: 'au2', name: 'Make_CRM_Sync_Pipeline.json', type: 'Automation', cat: 'Automation', size: '15 KB', thumb: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80', description: 'A massive Make.com (Integromat) scenario seamlessly syncing Shopify purchases, Stripe webhooks, and HubSpot CRM to trigger automated fulfillment protocols.', link: '#' },
