            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="pointer-events-auto bg-black/95 md:bg-black/80 backdrop-blur-3xl md:backdrop-blur-2xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] rounded-2xl w-[calc(100vw-32px)] sm:w-[380px] md:w-[400px] h-[65vh] md:h-[500px] max-h-[600px] md:max-h-[70vh] flex flex-col z-[200] mb-4 overflow-hidden overscroll-none origin-bottom-right"
                    >
                        {/* Chat Header */}
                        ...
                        {/* Input Area */}
                        <form onSubmit={handleSubmit} className="p-3 border-t border-white/10 bg-black/80 backdrop-blur-md relative">
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-full pl-5 pr-14 py-3 text-base md:text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-luxury-blue/50 transition-colors shadow-inner"
                                />
                                <button
                                    type="submit"
